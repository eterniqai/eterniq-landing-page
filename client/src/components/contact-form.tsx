        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button
              ...
              className="w-full bg-gradient-to-r from-[hsl(var(--royal-purple))] via-[hsl(var(--neon-pink))] to-[hsl(var(--electric-cyan))] hover:shadow-xl neon-glow hover:shadow-[hsl(var(--primary-blue))]/30 transition-all duration-300 px-8 py-4"
            >
